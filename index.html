...
<div id="app" style="display:none">
  ...
  <div class="drive-link-bar">
    ...
    <a href="https://drive.google.com/drive/folders/1xn9RQSOTxy7acph7xI0lGTlSSGLJqf83" target="_blank" rel="noopener" class="drive-link">Open Google Drive Folder →</a>
  </div>
      ...
      <div class="add-card" id="add-vocab-card">
        ...
        <div class="add-card-body">
          ...
          <div class="dg">
            ...
            <div class="fg"><label>Quarter</label><select id="v-quarter"><option value="">—</option><option>Q1</option><option>Q2</option><option>Q3</option><option>Q4</option></select></div>
...
<div id="edit-modal" style="display:none;position:fixed;inset:0;background:rgba(15,14,12,.4);z-index:9000;backdrop-filter:blur(4px);overflow:auto;padding:2rem">
  <div style="max-width:800px;margin:0 auto;background:var(--paper);border-radius:var(--radius);border:1px solid var(--border);box-shadow:var(--shadow-deep);padding:2.5rem">
    ...
    <div class="dg" style="margin-top:1.5rem">
      ...
      <div class="fg"><label>Quarter</label><select id="edit-quarter"><option value="">—</option><option>Q1</option><option>Q2</option><option>Q3</option><option>Q4</option></select></div>
  ...
  reader.onload = (e) => {
    ...
    preview.innerHTML = `
      <div class="image-preview">
        ...
        <button class="image-remove" onclick="removeImage('${previewId}', '${type}')">×</button>
      </div>
    `;
  };
  ...
  if (v.image) {
    ...
    g('edit-image-preview').innerHTML = `
      <div class="image-preview">
        ...
        <button class="image-remove" onclick="removeImage('edit-image-preview', 'edit')">×</button>
      </div>
    `;
  } else {
  ...
  if (quizMode === 'flashcard') {
    ...
    area.innerHTML = `
      ...
      <div class="btn-row" style="justify-content:center;display:none" id="next-btn-container">
        <button class="btn" onclick="quizIndex++;quizAnswered=false;showQuestion()">Next →</button>
      </div>
    `;
